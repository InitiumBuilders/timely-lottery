...
INSERT INTO "new_Initium" ("createdAt", "description", "id", "isPublic", "lastUsedAt", "mediaType", "mediaUrl", "slug", "timesUsed", "title", "updatedAt", "url", "userId", "viewCount") SELECT "createdAt", "description", "id", "isPublic", "lastUsedAt", "mediaType", "mediaUrl", "slug", "timesUsed", "title", "updatedAt", "url", "userId", "viewCount" FROM "Initium";
DROP TABLE "Initium";
